...
-- continent 'South America'. Divide the population by 1000000 to get population 
-- in millions.
...
-- For South America show population in millions and GDP in billions both to 2 decimal 
--  places.
SELECT name, round(population/1000000, 2), round(gdp/1000000000, 2) FROM world 
  WHERE continent = 'South America';

-- 10. Show the name and per-capita GDP for those countries with a GDP of at least one 
--   trillion (1000000000000; that is 12 zeros). Round this value to the nearest 1000.
...
-- 13. Equatorial Guinea and Dominican Republic have all of the vowels (a e i o u) in the 
--   name. They don't count because they have more than one word in the name.
