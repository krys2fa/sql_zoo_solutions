...
-- 9. Lesotho and Moldova both have two o characters separated by two other 
-- characters.
...
-- 11. The capital of Luxembourg is Luxembourg. Show all the countries where 
--   the capital is the same as the name of the country
...
-- Show the name and the extension where the capital is an extension of name of 
--   the country.
