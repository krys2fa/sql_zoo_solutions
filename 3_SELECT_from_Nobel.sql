...
-- 8. Show the year, subject, and name of Physics winners for 1980 together  
--   with the Chemistry winners for 1984.
SELECT yr, subject, winner FROM nobel WHERE yr = 1984 
  AND subject = 'Chemistry' UNION SELECT yr, subject, winner FROM nobel 
    WHERE yr = 1980 AND subject = 'Physics';

-- 9. Show the year, subject, and name of winners for 1980 excluding Chemistry 
--   and Medicine
SELECT yr, subject, winner FROM nobel WHERE yr = 1980 AND subject 
...
SELECT yr, subject, winner FROM nobel WHERE subject = 'Literature' 
  and yr >= 2004 union SELECT yr, subject, winner FROM nobel 
